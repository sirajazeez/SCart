    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="<cfoutput>#buildURL('subcategory.insert')#</cfoutput>">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subcatName" class="form-control" placeholder="Enter Sub Category Name" required="">
              </div>
